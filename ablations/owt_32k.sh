...
MODEL_ARGS="--num_layers 4 --d_model 256 --num_heads 8 --d_ff 1024 --context_length 512 --vocab_size 10000"
...
OUT_DIR="runs/owt_32k_H200_ctx512"
RUN_TAGS="owt_32k H200 BS256 step15k  ctx512"
PROJECT="LM_training"
